...
PROJECTS = {
    ...
    "🏆 DBT Artifacts Interactive Dashboard with Streamlit and Altair ": "https://github.com/DominikGolebiewski/golebiewski-streamlit/blob/e1e0dfa819ce3318fff039a06c90da389ec889d7/assets/img/dbt_artifacts_altair.png?raw=true"
}
